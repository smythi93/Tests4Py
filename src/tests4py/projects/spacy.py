        ...
        return [
            ...
            ast.Assign(
                ...
                value=ast.Call(
                    ...
                    args=[ast.Call(
                        func=ast.Name(id='Vocab', ctx=ast.Load()),
                        args=[],
                        keywords=[]
                    )],
                    keywords=[]
            ...
            ast.For(
                ...
                iter=ast.Tuple(
                    elts=[
                        ast.Constant(value="POSITIVE"),
                        ast.Constant(value="NEGATIVE")
                    ],
                    ctx=ast.Load()
                ),
                body=[
                    ...
                    ast.Expr(value=ast.Call(
                        func=ast.Attribute(
                            value=ast.Name(id='textcat', ctx=ast.Load()),
                            attr='add_label',
                            ctx=ast.Load()
                        ),
...
#
            ...
            # ),
            # ast.Assign(
            #     targets=[ast.Name(id='tokenizer')],
            #     value=ast.Call(
            #         func=ast.Attribute(
            #             value=ast.Attribute(
            #                 value=ast.Call(
            #                     func=ast.Name(id="get_lang_class", lineno=1),
            #                     args=[ast.Constant(value="en", lineno=1)],
            #                     keywords=[],
            #                 ),
            #                 attr='Defaults',
            #             ),
            #             attr='create_tokenizer',
            #         ),
            #         args=[],
            #         keywords=[],
            #     ),
            ...
            # ),
            # ast.Assign(
            #     targets=[ast.Name(id='tokens')],
            #     value=ast.Call(
            #         func=ast.Name(id='tokenizer'),
            ...
            #     value=ast.Call(
            #         func=ast.Name(id='get_doc'),
            #         args=[
            #             ast.Attribute(
            #                 value=ast.Name(id='tokens'),
            #                 attr='vocab',
            #             ),
            ...
            #                 generators=[
            #                     ast.comprehension(
            #                         target=ast.Name(id='t'),
            #                         iter=ast.Name(id='tokens'),
            #                         ifs=[],
            #                         is_async=0,
            #                     )
            #                 ],
            #             )),
            #             ast.keyword(arg='heads', value=ast.Name(id='heads')),
            #             ast.keyword(arg='deps',
            #                         value=ast.Name(id='deps'))
            #         ],
            #         keywords=[],
            #     ),
            #     lineno=6
...
#
    ...
    def get_imports(self) -> list[ImportFrom]:
        return [
            ...
            ast.ImportFrom(
                module="spacy.gold",
                names=[ast.alias(name="GoldParse")],
                level=0,
            ),
            ast.ImportFrom(
                module="spacy.util",
            ...
            ast.ImportFrom(
                module="spacy.tests.test_language",
                names=[ast.alias(name="nlp")],
                level=0,
            )
        ]
...
class SpaCyUnittestGenerator7(
    ...
    def _get_assert(text: str, filtered_length
        ...
        return [
            ...
            ast.Assign(
                targets=[ast.Name(id="filtered")],
                value=ast.Call(
                    func=ast.Name(id="filter_spans"),
                    args=[ast.Name(id="spans")],
                    keywords=[],
                ),
                lineno=12
            ),
            ast.Assert(
                test=ast.Compare(
                    left=ast.Call(
                        ...
                        args=[ast.Name(id="filtered")],
                        keywords=[],
                        lineno=13
                    ),
                    ops=[ast.Eq()],
                    comparators=[ast.Constant(value=filtered_length)],
                    lineno=13
                ),
                msg=None,
                lineno=13
    ...
    def get_imports(self) -> list[ImportFrom]:
        return [
            ...
            ast.ImportFrom(
                module="spacy.util",
                names=[ast.alias(name="filter_spans")],
                level=0,
            )
        ]
