...
17	.	_	PUNCT	.	_	10	punct	_	_
    ...
    @staticmethod
    def spacy6_generate():
        random_string1 = SpaCyTestGenerator.generate_random_string()
        random_string2 = SpaCyTestGenerator.generate_random_string()
        passing = random_string1, random_string2, "1"
        failing = random_string1, random_string2, "0"
        return passing, failing
    ...
    def spacy8_generate():
        ...
        pass_op = random.choice(["?", "*", "+", "1"])
        fail_op = "-"
        passing = random_string, pass_op
        failing = random_int, fail_op
        return passing, failing
...
class SpaCyUnittestGenerator6(
    ...
    @staticmethod
    def _get_assert(random_value1: str, random_value2: str) -> list[Module]:
        return [
            ast.Assign(
                targets=[ast.Attribute(value=ast.Name(id="spacy", lineno=1),
                                       attr="language.ENABLE_PIPELINE_ANALYSIS", lineno=1,
                                       )],
                value=ast.Constant(value=True, lineno=1),
                lineno=1
            ),
            ast.FunctionDef(
                name="c1",
                args=ast.arguments(
                    posonlyargs=[],
                    args=[ast.arg(arg="doc", annotation=None, lineno=2)],
                    kwonlyargs=[], kw_defaults=[], defaults=[],
                    lineno=2,
                ),
                body=[
                    ast.Return(value=ast.Name(id="doc", lineno=2), lineno=2,
                               )
                ],
                decorator_list=[
                    ast.Call(
                        func=ast.Name(id="component", lineno=2),
                        args=[ast.Constant(value=random_value1, lineno=2)],
                        keywords=[ast.keyword(arg="assigns", value=ast.List(
                            elts=[ast.Constant(value="token.tag", lineno=2)],
                            lineno=2), lineno=2)],
                        lineno=2
                    )
                ],
            ...
            ast.FunctionDef(
                ...
                args=ast.arguments(
                    posonlyargs=[],
                    args=[ast.arg(arg="doc", annotation=None, lineno=3)],
                    kwonlyargs=[], kw_defaults=[], defaults=[],
                    lineno=3
                ),
                body=[
                    ast.Return(value=ast.Name(id="doc", lineno=3), lineno=3,
                               )
                ],
                decorator_list=[
                    ast.Call(
                        func=ast.Name(id="component", lineno=3),
                        args=[ast.Constant(value=random_value2, lineno=3)],
                        keywords=[ast.keyword(arg="requires", value=ast.List(
                            elts=[ast.Constant(value="token.pos", lineno=3)],
                            lineno=3), lineno=3)],
                        lineno=3
                    )
                ],
            ...
            ast.Assign(
                targets=[ast.Name(id="nlp", lineno=4)],
                value=ast.Call(func=ast.Name(id="Language", lineno=4), args=[],
                               keywords=[], lineno=4),
                lineno=4
            ),
            ast.Expr(
                value=ast.Call(
                    func=ast.Attribute(value=ast.Name(id="nlp", lineno=5),
                                       attr="add_pipe", lineno=5),
                    args=[ast.Name(id="c1", lineno=5)],
                    keywords=[],
                    lineno=5
                ),
                lineno=5
            ...
            ast.With(
                items=[
                    ast.withitem(
                        context_expr=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id="pytest", lineno=6),
                                attr="warns", lineno=6),
                            args=[ast.Name(id="UserWarning", lineno=6)],
                            keywords=[],
                            lineno=6
                        ),
                        lineno=6
                ...
                body=[
                    ast.Expr(
                        value=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id="nlp", lineno=6),
                                attr="add_pipe", lineno=6),
                            args=[ast.Name(id="c2", lineno=6)],
                            keywords=[],
                            lineno=6
                        ),
                        lineno=6
            ...
            ast.With(
                items=[
                    ast.withitem(
                        context_expr=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id="pytest", lineno=7),
                                attr="warns", lineno=7),
                            args=[ast.Constant(value=None, lineno=7)],
                            keywords=[],
                            lineno=7
                        ),
                        optional_vars=ast.Name(id="record", lineno=7),
                        lineno=7
                    )
                ],
                body=[
                    ast.Expr(
                        value=ast.Call(
                            func=ast.Attribute(
                                ...
                                attr="remove_pipe", lineno=7),
                            args=[ast.Constant(value=random_value2, lineno=7)],
                            keywords=[],
                            lineno=7
                        ),
                        lineno=7
    ...
    @staticmethod
    def _get_assert_2(random_value1: str, random_value2: str) -> list[Module]:
        return [
    ...
    def generate_failing_test(self) -> Tuple[ast.FunctionDef, TestResult]:
        _, fail_ = self._generate_one()
        random_value1, random_value2, assertion_case = fail_
        test = self.get_empty_test()
        test.body = self._get_assert_2(random_value1, random_value2)
        return test, TestResult.FAILING

    def generate_passing_test(self) -> Tuple[ast.FunctionDef, TestResult]:
        pass_, _ = self._generate_one()
        random_value1, random_value2, assertion_case = pass_
        test = self.get_empty_test()
        test.body = self._get_assert(random_value1, random_value2)
        return test, TestResult.PASSING
    ...
    def _get_assert(text: str, filtered_length
        ...
        return [
            ...
            ast.FunctionDef(
                ...
                body=[
                    ast.Assign(
                        ...
                        value=ast.Constant(value=text, lineno=2),
                        lineno=2
                    ),
                    ast.Assign(
            ...
            ast.FunctionDef(
                ...
                args=ast.arguments(
                    posonlyargs=[],
                    args=[ast.arg(arg='doc', annotation=None, lineno=1)],
                    kwonlyargs=[],
                    kw_defaults=[],
                    defaults=[],
                    lineno=1
                ...
                body=[
                    ast.Assign(
                        ...
                        value=ast.List(
                            elts=[
                                ast.Subscript(
                                    value=ast.Name(id="doc", lineno=1),
                                    slice=ast.Slice(
                                        lower=ast.Constant(value=1, lineno=1),
                                        upper=ast.Constant(value=4, lineno=1),
                                        step=None,
                                        lineno=1
                                    ),
                                ...
                                ast.Subscript(
                                    value=ast.Name(id="doc", lineno=1),
                                    slice=ast.Slice(
                                        lower=ast.Constant(value=6, lineno=1),
                                        upper=ast.Constant(value=8, lineno=1),
                                        step=None,
                                        lineno=1
                                    ),
                                ...
                                ast.Subscript(
                                    value=ast.Name(id="doc", lineno=1),
                                    slice=ast.Slice(
                                        lower=ast.Constant(value=10, lineno=1),
                                        upper=ast.Constant(value=14, lineno=1),
                                        step=None,
                                        lineno=1
                                    ),
                    ...
                    ast.Assert(
                        test=ast.Compare(
                            left=ast.Call(
                                ...
                                args=[ast.Name(id="filtered", lineno=3)],
                                keywords=[],
                                lineno=3
                            ),
                            ops=[ast.Eq()],
                            ...
                            values=[
                                ast.Compare(
                                    left=ast.Attribute(
                                        value=ast.Subscript(
                                            value=ast.Name(id="filtered", lineno=4),
                                            slice=ast.Constant(value=1, lineno=4),
                                            lineno=4
                                        ),
                                        attr="start",
                                        lineno=4
                                    ...
                                    ops=[ast.Eq()],
                                    comparators=[ast.Constant(value=6, lineno=4)],
                                    lineno=4
                                ),
                                ast.Compare(
                                    left=ast.Attribute(
                                    ...
                                    ops=[ast.Eq()],
                                    comparators=[ast.Constant(value=8, lineno=4)],
                                    lineno=4
                                ),
                            ],
                            lineno=4
                            ...
                            values=[
                                ast.Compare(
                                    left=ast.Attribute(
                                        value=ast.Subscript(
                                            value=ast.Name(id="filtered", lineno=4),
                                            slice=ast.Constant(value=2, lineno=4),
                                            lineno=4
                                        ),
                                        attr="start",
                                        lineno=4
                                    ...
                                    ops=[ast.Eq()],
                                    comparators=[ast.Constant(value=10, lineno=4)],
                                    lineno=4
                                ),
                                ast.Compare(
                                    left=ast.Attribute(
                                    ...
                                    ops=[ast.Eq()],
                                    comparators=[ast.Constant(value=14, lineno=4)],
                                    lineno=4
                                ),
                            ],
                            lineno=4
...
class SpaCyUnittestGenerator8(
    ...
    @staticmethod
    def _get_assert(random_value: str | int, operator: str
                    ) -> list[Assign | Assert | Expr]:
        return [
            ast.Assign(
                targets=[ast.Name(id='matcher', lineno=1)],
                value=ast.Call(
                    func=ast.Name(id='Matcher', lineno=1),
                    args=[ast.Call(
                        func=ast.Attribute(
                            value=ast.Call(
                                func=ast.Name(id='get_lang_class'),
            ...
            ast.Assign(
                targets=[ast.Name(id='pattern', lineno=2)],
                value=ast.List(
                    elts=[
                        ast.Dict(
                            keys=[ast.Constant(value='ORTH', lineno=2)],
                            values=[ast.Constant(value=random_value, lineno=2)],
                            lineno=2
                        ),
                        ast.Dict(
                            keys=[ast.Constant(value='OP', lineno=2)],
                            values=[ast.Constant(value=operator, lineno=2)],
                            lineno=2
                        )
                    ],
            ...
            ast.Assert(
                test=ast.Compare(
                    left=ast.Call(
                        func=ast.Name(id='len', lineno=3),
                        args=[ast.Name(id='matcher', lineno=3)],
                        keywords=[],
                        lineno=3
                    ),
                    ops=[ast.Eq(lineno=3)],
                    comparators=[ast.Constant(value=0, lineno=3)],
                    lineno=3
                ),
                lineno=3
            ),
            ast.Expr(
                value=ast.Call(
                    func=ast.Attribute(
                        value=ast.Name(id='matcher', lineno=4),
                        attr='add',
                        lineno=4
                    ),
                    args=[
                        ast.Constant(value='Rule', lineno=4),
                        ast.Constant(value=None, lineno=4),
                        ast.Name(id='pattern', lineno=4)
                    ],
                    keywords=[],
                    lineno=4
                ),
            ...
            ast.Assert(
                test=ast.Compare(
                    left=ast.Constant(value='Rule', lineno=5),
                    ops=[ast.In(lineno=5)],
                    comparators=[ast.Name(id='matcher', lineno=5)],
                    lineno=5
                ),
                lineno=5
            )
    ...
    def generate_failing_test(self) -> Tuple[ast.FunctionDef, TestResult]:
        _, fail_ = self._generate_one()
        ramdom_value, operator = fail_
        test = self.get_empty_test()
        test.body = self._get_assert(ramdom_value, operator)
        return test, TestResult.FAILING

    def generate_passing_test(self) -> Tuple[ast.FunctionDef, TestResult]:
        pass_, _ = self._generate_one()
        ramdom_value, operator = pass_
        test = self.get_empty_test()
        test.body = self._get_assert(ramdom_value, operator)
        return test, TestResult.PASSING
...
class SpaCyUnittestGenerator9(
    ...
    def _get_assert(randomise: str, builtin_spacy_pipeline: str
        ...
        return [
            ...
            ast.Assign(
                targets=[ast.Name(id='tagger', ctx=ast.Store(), lineno=3)],
                value=ast.Call(
                    func=ast.Attribute(
                        value=ast.Name(id='nlp', ctx=ast.Load(), lineno=3),
                        attr='create_pipe', ctx=ast.Load(), lineno=3
                    ),
    ...
    def _get_assert_2(randomise: str, builtin_spacy_pipeline: str
        ...
        return [
            ...
            ast.Assign(
                targets=[ast.Name(id='nlp', ctx=ast.Store(), lineno=1)],
                value=ast.Call(
                    func=ast.Name(id='English', ctx=ast.Load(), lineno=1),
                    args=[],
                    keywords=[],
                    lineno=1
                ),
            ...
            ast.Assign(
                targets=[ast.Attribute(
                    value=ast.Attribute(
                        value=ast.Name(id='nlp', ctx=ast.Load(), lineno=2),
                        attr='vocab', ctx=ast.Load(), lineno=2
                    ),
                    attr='lookups', ctx=ast.Store(), lineno=2
                )],
                value=ast.Call(
                    func=ast.Name(id='Lookups', ctx=ast.Load(), lineno=2),
                    args=[],
                    keywords=[],
                    lineno=2
                ),
            ...
            ast.Assert(
                test=ast.UnaryOp(
                    op=ast.Not(),
                    operand=ast.Call(
                        func=ast.Name(id='len', ctx=ast.Load(), lineno=3),
                        args=[ast.Attribute(
                            value=ast.Attribute(
                                value=ast.Name(id='nlp', ctx=ast.Load(), lineno=3),
                                attr='vocab', ctx=ast.Load(), lineno=3
                            ),
                            attr='lookups', ctx=ast.Load(), lineno=3
                        )],
                        keywords=[],
                        lineno=3
                    ),
            ...
            ast.Assign(
                targets=[ast.Name(id='tagger', ctx=ast.Store(), lineno=4)],
                value=ast.Call(
                    func=ast.Attribute(
                        value=ast.Name(id='nlp', ctx=ast.Load(), lineno=4),
                        attr='create_pipe', ctx=ast.Load(), lineno=4
                    ),
            ...
            ast.With(
                items=[
                    ast.withitem(
                        context_expr=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='pytest', ctx=ast.Load(), lineno=5),
                                attr='warns', ctx=ast.Load(), lineno=5
                            ),
                            args=[ast.Name(id='UserWarning', ctx=ast.Load(), lineno=5)],
                            keywords=[],
                            lineno=5
                        ),
                        optional_vars=None
                ...
                body=[
                    ast.Expr(
                        value=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='tagger', ctx=ast.Load(), lineno=6),
                                attr='begin_training', ctx=ast.Load(), lineno=6
                            ),
            ...
            ast.Expr(
                value=ast.Call(
                    func=ast.Attribute(
                        value=ast.Name(id='nlp', ctx=ast.Load(), lineno=7),
                        attr='add_pipe', ctx=ast.Load(), lineno=7
                    ),
                    args=[ast.Name(id='tagger', ctx=ast.Load(), lineno=7)],
                    keywords=[],
                    lineno=7
                ),
                lineno=7
            ...
            ast.With(
                items=[
                    ast.withitem(
                        context_expr=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='pytest', ctx=ast.Load(), lineno=8),
                                attr='warns', ctx=ast.Load(), lineno=8
                            ),
                            args=[ast.Name(id='UserWarning', ctx=ast.Load(), lineno=8)],
                            keywords=[],
                            lineno=8
                        ),
                        optional_vars=None
                ...
                body=[
                    ast.Expr(
                        value=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='nlp', ctx=ast.Load(), lineno=9),
                                attr='begin_training', ctx=ast.Load(), lineno=9
                            ),
                ...
                value=ast.Call(
                    func=ast.Attribute(  # The function being called is `nlp.vocab.lookups.add_table`
                        value=ast.Attribute(  # First, access `nlp.vocab`
                            value=ast.Attribute(
                                value=ast.Name(id='nlp', ctx=ast.Load(), lineno=10),
                                attr='vocab', ctx=ast.Load(), lineno=10
                            ),
                            attr='lookups', ctx=ast.Load(), lineno=10  # Then access `lookups`
                        ),
                        attr='add_table', ctx=ast.Load(), lineno=10  # Finally, `add_table`
                    ),
                    args=[ast.Constant(value='lemma_lookup', lineno=10)],  # Arguments to the function
                    keywords=[],  # No keyword arguments
                    lineno=10  # The line number for the `ast.Call`
                ),
                lineno=10  # Line number for the `ast.Expr`
            ),
            ...
            ast.With(
                items=[
                    ast.withitem(
                        ...
                        optional_vars=ast.Name(id='record', ctx=ast.Store(), lineno=11)
                    )
                ],
                body=[
                    ast.Expr(
                        value=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='nlp', ctx=ast.Load(), lineno=12),
                                attr='begin_training', ctx=ast.Load(), lineno=12
                            ),
                    ...
                    ast.Assert(
                        test=ast.UnaryOp(
                            op=ast.Not(),
                            operand=ast.Attribute(
                                value=ast.Name(id='record', ctx=ast.Load(), lineno=13),
                                attr='list', ctx=ast.Load(), lineno=13
                            ),
                            lineno=13
                        ),
                        lineno=13
            ...
            ast.With(
                items=[
                    ast.withitem(
                        context_expr=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='pytest', lineno=2),
                                attr='raises',

                                lineno=2
                            ),
                            args=[ast.Name(id='ValueError', lineno=2)],
                            keywords=[],
                            lineno=2
                        ),
                        optional_vars=None
                ...
                body=[
                    ast.Expr(
                        value=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='matcher', lineno=3),
                                attr='add',

                                lineno=3
                            ),
                            args=[
                                ast.Constant(value=random_name, lineno=3),
                                ast.List(elts=[], lineno=3),
                                ast.List(
                                    elts=[
                                        ast.Dict(
                                            keys=[ast.Constant(value=pattern, lineno=3)],
                                            values=[ast.Constant(value='test', lineno=3)],
                                            lineno=3
                                        )
                                    ],
