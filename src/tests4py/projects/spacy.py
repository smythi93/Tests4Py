...
17	.	_	PUNCT	.	_	10	punct	_	_
    ...
    def spacy10_generate():
        random_string = SpaCyTestGenerator.generate_random_string()
        passing = (random_string, "INVALID KEY")
        failing = (random_string, "TEXT")
        return passing, failing
...
class SpaCyUnittestGenerator2(
    ...
    def _get_assert(value1: str, value2: str
                    ) -> list[ClassDef | Assign | Expr | Assert]:
        return [
            ast.ClassDef(
                name='MyComponent',
                bases=[],
        ...
        return [
            ast.Module(
                body=[
                    ...
                    ast.Assign(
                        targets=[ast.Name(id='doc')],
                        value=ast.Call(
                            func=ast.Name(id='nlp'),
                            args=[ast.Name(id='text')],
                            keywords=[],
                            lineno=4,
                            col_offset=0
                        ),
    ...
    def _get_assert(
        ...
        return [
            ast.Module(
                body=[
                    ast.Assign(
                        targets=[ast.Attribute(value=ast.Name(id="spacy", ctx=ast.Load(), lineno=1, col_offset=0),
                                               attr="language.ENABLE_PIPELINE_ANALYSIS", ctx=ast.Store(), lineno=1,
                                               col_offset=0)],
                        value=ast.Constant(value=True, lineno=1, col_offset=30),
                    ...
                    ast.FunctionDef(
                        ...
                        args=ast.arguments(
                            posonlyargs=[],
                            args=[ast.arg(arg="doc", annotation=None, lineno=3, col_offset=17)],
                            kwonlyargs=[], kw_defaults=[], defaults=[],
                            lineno=3, col_offset=17
                        ),
                        body=[
                            ast.Return(value=ast.Name(id="doc", ctx=ast.Load(), lineno=4, col_offset=12), lineno=4,
                                       col_offset=8)
                        ],
                        decorator_list=[
                            ast.Call(
                                func=ast.Name(id="component", ctx=ast.Load(), lineno=2, col_offset=1),
                                args=[ast.Constant(value="c1", lineno=2, col_offset=11)],
                                keywords=[ast.keyword(arg="assigns", value=ast.List(
                                    elts=[ast.Constant(value="token.tag", lineno=2, col_offset=30)], ctx=ast.Load(),
                                    lineno=2, col_offset=30), lineno=2, col_offset=19)],
                                lineno=2, col_offset=1
                            )
                        ],
                    ...
                    ast.FunctionDef(
                        ...
                        args=ast.arguments(
                            posonlyargs=[],
                            args=[ast.arg(arg="doc", annotation=None, lineno=7, col_offset=17)],
                            kwonlyargs=[], kw_defaults=[], defaults=[],
                            lineno=7, col_offset=17
                        ),
                        body=[
                            ast.Return(value=ast.Name(id="doc", ctx=ast.Load(), lineno=8, col_offset=12), lineno=8,
                                       col_offset=8)
                        ],
                        decorator_list=[
                            ast.Call(
                                func=ast.Name(id="component", ctx=ast.Load(), lineno=6, col_offset=1),
                                args=[ast.Constant(value="c2", lineno=6, col_offset=11)],
                                keywords=[ast.keyword(arg="requires", value=ast.List(
                                    elts=[ast.Constant(value="token.pos", lineno=6, col_offset=30)], ctx=ast.Load(),
                                    lineno=6, col_offset=30), lineno=6, col_offset=19)],
                    ...
                    ast.Assign(
                        targets=[ast.Name(id="nlp", ctx=ast.Store(), lineno=10, col_offset=0)],
                        value=ast.Call(func=ast.Name(id="Language", ctx=ast.Load(), lineno=10, col_offset=5), args=[],
                                       keywords=[], lineno=10, col_offset=5),
                        lineno=10, col_offset=0
                    ),
                    ast.Expr(
                        value=ast.Call(
                            func=ast.Attribute(value=ast.Name(id="nlp", ctx=ast.Load(), lineno=11, col_offset=0),
                                               attr="add_pipe", ctx=ast.Load(), lineno=11, col_offset=4),
                            args=[ast.Name(id="c1", ctx=ast.Load(), lineno=11, col_offset=14)],
                            keywords=[],
                            lineno=11, col_offset=4
                        ),
                        ...
                        items=[
                            ast.withitem(
                                context_expr=ast.Call(
                                    func=ast.Attribute(
                                        value=ast.Name(id="pytest", ctx=ast.Load(), lineno=12, col_offset=4),
                                        attr="warns", ctx=ast.Load(), lineno=12, col_offset=11),
                                    args=[ast.Name(id="UserWarning", ctx=ast.Load(), lineno=12, col_offset=17)],
                                    keywords=[],
                                    lineno=12, col_offset=11
                                ),
                                lineno=12, col_offset=4
                            )
                        ],
                        body=[
                            ast.Expr(
                                value=ast.Call(
                                    func=ast.Attribute(
                                        value=ast.Name(id="nlp", ctx=ast.Load(), lineno=13, col_offset=8),
                                        attr="add_pipe", ctx=ast.Load(), lineno=13, col_offset=12),
                                    args=[ast.Name(id="c2", ctx=ast.Load(), lineno=13, col_offset=22)],
                                    keywords=[],
                                    lineno=13, col_offset=12
                                ),
                                lineno=13, col_offset=8
                            )
                        ],
                        lineno=12, col_offset=4
                    ),
                    ast.With(
                        items=[
                            ast.withitem(
                                context_expr=ast.Call(
                                    func=ast.Attribute(
                                        value=ast.Name(id="pytest", ctx=ast.Load(), lineno=14, col_offset=4),
                                        attr="warns", ctx=ast.Load(), lineno=14, col_offset=11),
                                    args=[ast.Constant(value=None, lineno=14, col_offset=17)],
                                    keywords=[],
                                    lineno=14, col_offset=11
                                ),
                                optional_vars=ast.Name(id="record", ctx=ast.Store(), lineno=14, col_offset=23),
                                lineno=14, col_offset=4
                            )
                        ],
                        body=[
                            ast.Expr(
                                value=ast.Call(
                                    func=ast.Attribute(
                                        value=ast.Name(id="nlp", ctx=ast.Load(), lineno=15, col_offset=8),
                                        attr="remove_pipe", ctx=ast.Load(), lineno=15, col_offset=12),
                                    args=[ast.Constant(value="c2", lineno=15, col_offset=24)],
                                    keywords=[],
                                    lineno=15, col_offset=12
                                ),
                                lineno=15, col_offset=8
                            )
                        ],
                        lineno=14, col_offset=4
                    ),
                    ast.Assert(
                        test=ast.UnaryOp(op=ast.Not(), operand=ast.Attribute(
                            value=ast.Name(id="record", ctx=ast.Load(), lineno=16, col_offset=15), attr="list",
                            ctx=ast.Load(), lineno=16, col_offset=22), lineno=16, col_offset=8),
                        msg=None,
                        lineno=16, col_offset=8
                    )
                ],
                type_ignores=[]
            )
                ...
                body=[
                    ast.FunctionDef(
                        ...
                        body=[
                            ast.Return(
                                value=ast.Call(
                                    func=ast.Attribute(
                                        value=ast.Call(
                                            func=ast.Name(id="get_lang_class", ctx=ast.Load(), lineno=2, col_offset=10),
                                            args=[ast.Constant(value="en", lineno=2, col_offset=24)],
                                            keywords=[],
                                            lineno=2, col_offset=10
                                        ),
                                        attr='Defaults',
                                        ctx=ast.Load(),
                                        lineno=2, col_offset=35
                                    ),
                                    args=[],
                                    keywords=[],
                                    lineno=2, col_offset=35
                        ...
                        decorator_list=[
                            ast.Call(
                                func=ast.Attribute(
                                    value=ast.Name(id='pytest', ctx=ast.Load(), lineno=1, col_offset=1),
                                    attr='fixture',
                                    ctx=ast.Load(),
                                ...
                                args=[
                                    ast.keyword(arg='scope',
                                                value=ast.Constant(value="session", lineno=1, col_offset=20))
                                ],
                                keywords=[],
                                lineno=1, col_offset=1
                            )
                    ...
                    ast.FunctionDef(
                        ...
                        args=ast.arguments(
                            posonlyargs=[],
                            args=[ast.arg(arg='en_tokenizer', annotation=None, lineno=1, col_offset=15)],
                            kwonlyargs=[],
                            kw_defaults=[],
                            defaults=[],
                            lineno=1, col_offset=10
                        ),
                        body=[
                            ast.Assign(
                                targets=[ast.Name(id='text', ctx=ast.Store(), lineno=2, col_offset=4)],
                                value=ast.Constant(value="This is a sentence. This is another sentence. And a third.",
                                                   lineno=2, col_offset=10),
                                lineno=2, col_offset=4
                            ),
                            ast.Assign(
                                targets=[ast.Name(id='heads', ctx=ast.Store(), lineno=3, col_offset=4)],
                                value=ast.List(
                                    elts=[
                                        ast.Constant(value=1, lineno=3, col_offset=12),
                                        ast.Constant(value=0, lineno=3, col_offset=14),
                                        ast.Constant(value=1, lineno=3, col_offset=16),
                                        ast.Constant(value=-2, lineno=3, col_offset=18),
                                        ast.Constant(value=-3, lineno=3, col_offset=21),
                                        ast.Constant(value=1, lineno=3, col_offset=24),
                                        ast.Constant(value=0, lineno=3, col_offset=26),
                                        ast.Constant(value=1, lineno=3, col_offset=28),
                                        ast.Constant(value=-2, lineno=3, col_offset=30),
                                        ast.Constant(value=-3, lineno=3, col_offset=33),
                                        ast.Constant(value=0, lineno=3, col_offset=36),
                                        ast.Constant(value=1, lineno=3, col_offset=38),
                                        ast.Constant(value=-2, lineno=3, col_offset=40),
                                        ast.Constant(value=-1, lineno=3, col_offset=43)
                                    ],
                                    ctx=ast.Load(),
                                    lineno=3, col_offset=10
                                ),
                                lineno=3, col_offset=4
                            ),
                            ast.Assign(
                                targets=[ast.Name(id='deps', ctx=ast.Store(), lineno=4, col_offset=4)],
                                value=ast.List(
                                    elts=[
                                        ast.Constant(value="nsubj", lineno=4, col_offset=11),
                                        ast.Constant(value="ROOT", lineno=4, col_offset=19),
                                        ast.Constant(value="det", lineno=4, col_offset=27),
                                        ast.Constant(value="attr", lineno=4, col_offset=34),
                                        ast.Constant(value="punct", lineno=4, col_offset=42),
                                        ast.Constant(value="nsubj", lineno=4, col_offset=50),
                                        ast.Constant(value="ROOT", lineno=4, col_offset=58),
                                        ast.Constant(value="det", lineno=4, col_offset=66),
                                        ast.Constant(value="attr", lineno=4, col_offset=73),
                                        ast.Constant(value="punct", lineno=4, col_offset=81),
                                        ast.Constant(value="ROOT", lineno=4, col_offset=89),
                                        ast.Constant(value="det", lineno=4, col_offset=97),
                                        ast.Constant(value="npadvmod", lineno=4, col_offset=105),
                                        ast.Constant(value="punct", lineno=4, col_offset=116)
                                    ],
                                    ctx=ast.Load(),
                                    lineno=4, col_offset=10
                                ),
                                lineno=4, col_offset=4
                            ),
                            ast.Assign(
                                targets=[ast.Name(id='tokens', ctx=ast.Store(), lineno=5, col_offset=4)],
                                value=ast.Call(
                                    func=ast.Name(id='en_tokenizer', ctx=ast.Load(), lineno=5, col_offset=12),
                                    args=[ast.Name(id='text', ctx=ast.Load(), lineno=5, col_offset=25)],
                                    keywords=[],
                                    lineno=5, col_offset=12
                                ),
                                lineno=5, col_offset=4
                            ),
                            ast.Return(
                                value=ast.Call(
                                    func=ast.Name(id='get_doc', ctx=ast.Load(), lineno=6, col_offset=11),
                                    args=[
                                        ast.Attribute(
                                            value=ast.Name(id='tokens', ctx=ast.Load(), lineno=6, col_offset=20),
                                            attr='vocab',
                                            ctx=ast.Load(),
                                            lineno=6, col_offset=27
                                        ),
                                        ast.keyword(arg='words', value=ast.ListComp(
                                            elt=ast.Attribute(
                                                value=ast.Name(id='t', ctx=ast.Load(), lineno=6, col_offset=41),
                                                attr='text',
                                                ctx=ast.Load(),
                                                lineno=6, col_offset=43
                                            ),
                                            generators=[
                                                ast.comprehension(
                                                    target=ast.Name(id='t', ctx=ast.Store(), lineno=6, col_offset=53),
                                                    iter=ast.Name(id='tokens', ctx=ast.Load(), lineno=6, col_offset=55),
                                                    ifs=[],
                                                    is_async=0,
                                                    lineno=6, col_offset=53
                                                )
                                            ],
                                            lineno=6, col_offset=41
                                        )),
                                        ast.keyword(arg='heads', value=ast.Name(id='heads', ctx=ast.Load(), lineno=6,
                                                                                col_offset=66)),
                                        ast.keyword(arg='deps',
                                                    value=ast.Name(id='deps', ctx=ast.Load(), lineno=6, col_offset=76))
                                    ],
                                    keywords=[],
                                    lineno=6, col_offset=11
                                ),
                        ...
                        decorator_list=[
                            ast.Call(
                                func=ast.Attribute(value=ast.Name(id='pytest', ctx=ast.Load(), lineno=1, col_offset=1),
                                                   attr='fixture', ctx=ast.Load(), lineno=1, col_offset=1),
                                args=[],
                                keywords=[],
                                lineno=1, col_offset=1
                            )
                    ...
                    ast.Assign(
                        targets=[ast.Name(id="spans", ctx=ast.Store(), lineno=1, col_offset=0)],
                        value=ast.List(
                            elts=[
                                ast.Subscript(
                                    value=ast.Name(id="doc", ctx=ast.Load(), lineno=1, col_offset=9),
                                    slice=ast.Slice(
                                        lower=ast.Constant(value=1, lineno=1, col_offset=13),
                                        upper=ast.Constant(value=4, lineno=1, col_offset=15),
                                        step=None,
                                ...
                                ast.Subscript(
                                    value=ast.Name(id="doc", ctx=ast.Load(), lineno=1, col_offset=18),
                                    slice=ast.Slice(
                                        lower=ast.Constant(value=6, lineno=1, col_offset=22),
                                        upper=ast.Constant(value=8, lineno=1, col_offset=24),
                                        step=None,
                                        lineno=1, col_offset=22
                                    ),
                                    ctx=ast.Load(),
                                    lineno=1, col_offset=18
                                ),
                                ast.Subscript(
                                    value=ast.Name(id="doc", ctx=ast.Load(), lineno=1, col_offset=27),
                                    slice=ast.Slice(
                                        lower=ast.Constant(value=1, lineno=1, col_offset=31),
                                        upper=ast.Constant(value=4, lineno=1, col_offset=33),
                                        step=None,
                                        lineno=1, col_offset=31
                                    ),
                                    ctx=ast.Load(),
                                    lineno=1, col_offset=27
                                ),
                                ast.Subscript(
                                    value=ast.Name(id="doc", ctx=ast.Load(), lineno=1, col_offset=36),
                                    slice=ast.Slice(
                                        lower=ast.Constant(value=10, lineno=1, col_offset=40),
                                        upper=ast.Constant(value=14, lineno=1, col_offset=43),
                                        step=None,
                                        lineno=1, col_offset=40
                                    ),
                                    ctx=ast.Load(),
                                    lineno=1, col_offset=36
                                ),
                            ],
                            ctx=ast.Load(),
                            lineno=1, col_offset=9
                    ...
                    # Call filter_spans(spans)
                    ast.Assign(
                        targets=[ast.Name(id="filtered", ctx=ast.Store(), lineno=2, col_offset=0)],
                        value=ast.Call(
                            func=ast.Name(id="filter_spans", ctx=ast.Load(), lineno=2, col_offset=11),
                            args=[ast.Name(id="spans", ctx=ast.Load(), lineno=2, col_offset=24)],
                            keywords=[],
                            lineno=2, col_offset=11
                        ),
                    ...
                    ast.Assert(
                        test=ast.Compare(
                            left=ast.Call(
                                func=ast.Name(id="len", ctx=ast.Load(), lineno=3, col_offset=7),
                                args=[ast.Name(id="filtered", ctx=ast.Load(), lineno=3, col_offset=11)],
                                keywords=[],
                                lineno=3, col_offset=7
                            ),
                            ops=[ast.Eq()],
                            comparators=[ast.Constant(value=3, lineno=3, col_offset=24)],
                            lineno=3, col_offset=7
                        ),
                        msg=None,
                        lineno=3, col_offset=0
                        ...
                        test=ast.BoolOp(
                            ...
                            values=[
                                ast.Compare(
                                    left=ast.Attribute(
                                        value=ast.Subscript(
                                            value=ast.Name(id="filtered", ctx=ast.Load(), lineno=4, col_offset=7),
                                            slice=ast.Constant(value=0, lineno=4, col_offset=16),
                                            ctx=ast.Load(),
                                            lineno=4, col_offset=16
                                        ),
                                        attr="start",
                                        ctx=ast.Load(),
                                        lineno=4, col_offset=7
                                    ),
                                    ops=[ast.Eq()],
                                    comparators=[ast.Constant(value=1, lineno=4, col_offset=29)],
                                    lineno=4, col_offset=7
                                ),
                                ast.Compare(
                                    left=ast.Attribute(
                                        value=ast.Subscript(
                                            value=ast.Name(id="filtered", ctx=ast.Load(), lineno=4, col_offset=38),
                                            slice=ast.Constant(value=0, lineno=4, col_offset=47),
                                            ctx=ast.Load(),
                                            lineno=4, col_offset=47
                                        ),
                                        attr="end",
                                        ctx=ast.Load(),
                                        lineno=4, col_offset=38
                                    ),
                                    ops=[ast.Eq()],
                                    comparators=[ast.Constant(value=4, lineno=4, col_offset=60)],
                                    lineno=4, col_offset=38
                                ),
                            ],
...
class SpaCyUnittestGenerator8(
    ...
    @staticmethod
    def _get_assert(
    ) -> list[Assign | Assert | Expr]:
        return [
            ast.Assign(
                targets=[ast.Name(id='matcher', ctx=ast.Store(), lineno=6, col_offset=4)],
                value=ast.Call(
                    func=ast.Name(id='Matcher', ctx=ast.Load(), lineno=6, col_offset=14),
                    args=[ast.Call(
                        func=ast.Attribute(
                            value=ast.Call(
                                func=ast.Name(id='get_lang_class', ctx=ast.Load()),
                                args=[ast.Constant(value='en')],
                                keywords=[]
                            ),
                            attr='Defaults.create_vocab',
                            ctx=ast.Load()
                        ),
                        args=[],
                        keywords=[]
                    ...
                    keywords=[],
                    lineno=6, col_offset=14
                ),
                lineno=6, col_offset=4
            ),
            ast.Assign(
                targets=[ast.Name(id='pattern', ctx=ast.Store(), lineno=7, col_offset=4)],
                value=ast.List(
                    elts=[
                        ast.Dict(
                            keys=[ast.Constant(value='ORTH', lineno=7, col_offset=16)],
                            values=[ast.Constant(value='test', lineno=7, col_offset=24)],
                            lineno=7, col_offset=16
                        ),
                        ast.Dict(
                            keys=[ast.Constant(value='OP', lineno=7, col_offset=40)],
                            values=[ast.Constant(value='?', lineno=7, col_offset=46)],
                            lineno=7, col_offset=40
                        )
                    ],
                    ctx=ast.Load(),
                    lineno=7, col_offset=14
                ),
                lineno=7, col_offset=4
            ),
            ast.Assert(
                test=ast.Compare(
                    left=ast.Call(
                        func=ast.Name(id='len', ctx=ast.Load(), lineno=8, col_offset=11),
                        args=[ast.Name(id='matcher', ctx=ast.Load(), lineno=8, col_offset=15)],
                        keywords=[],
                        lineno=8, col_offset=11
                    ),
                    ops=[ast.Eq(lineno=8, col_offset=25)],
                    comparators=[ast.Constant(value=0, lineno=8, col_offset=29)],
                    lineno=8, col_offset=11
                ),
                lineno=8, col_offset=4
            ),
            ast.Expr(
                value=ast.Call(
                    func=ast.Attribute(
                        value=ast.Name(id='matcher', ctx=ast.Load(), lineno=9, col_offset=4),
                        attr='add',
                        ctx=ast.Load(),
                        lineno=9, col_offset=14
                    ),
                    args=[
                        ast.Constant(value='Rule', lineno=9, col_offset=19),
                        ast.Constant(value=None, lineno=9, col_offset=26),
                        ast.Name(id='pattern', ctx=ast.Load(), lineno=9, col_offset=32)
                    ],
                    keywords=[],
                    lineno=9, col_offset=14
                ),
                lineno=9, col_offset=4
            ),
            ast.Assert(
                test=ast.Compare(
                    left=ast.Constant(value='Rule', lineno=10, col_offset=11),
                    ops=[ast.In(lineno=10, col_offset=18)],
                    comparators=[ast.Name(id='matcher', ctx=ast.Load(), lineno=10, col_offset=21)],
                    lineno=10, col_offset=11
                ),
                lineno=10, col_offset=4
            )
        ]
...
class SpaCyUnittestGenerator9(
    ...
    def _get_assert(
        ...
        return [
            ast.Assign(
                targets=[ast.Name(id='nlp', ctx=ast.Store(), lineno=1, col_offset=0)],
                value=ast.Call(
                    func=ast.Name(id='English', ctx=ast.Load(), lineno=1, col_offset=6),
                    args=[],
                    keywords=[],
            ...
            ast.Assign(
                targets=[
                    ast.Attribute(
                        value=ast.Attribute(
                            value=ast.Name(id='nlp', ctx=ast.Load(), lineno=2, col_offset=0),
                            attr='vocab',
                            ctx=ast.Load(),
                            lineno=2, col_offset=4
                        ),
                ...
                value=ast.Call(
                    func=ast.Name(id='Lookups', ctx=ast.Load(), lineno=2, col_offset=20),
                    args=[],
                    keywords=[],
            ...
            ast.Assert(
                test=ast.UnaryOp(
                    op=ast.Not(),
                    operand=ast.Call(
                        func=ast.Name(id='len', ctx=ast.Load(), lineno=3, col_offset=11),
                        args=[
                            ast.Attribute(
                                value=ast.Attribute(
                                    value=ast.Name(id='nlp', ctx=ast.Load(), lineno=3, col_offset=15),
                                    attr='vocab',
                                    ctx=ast.Load(),
                                    lineno=3, col_offset=19
                                ),
                                attr='lookups',
                                ctx=ast.Load(),
                                lineno=3, col_offset=25
                            )
                        ],
                        keywords=[],
...
class SpaCyUnittestGenerator10(
    ...
    @staticmethod
    def _get_assert(random_name: str, pattern: str
    ) -> list[Assign | With | Expr]:
        return [
            ast.Assign(
                targets=[ast.Name(id='matcher', ctx=ast.Store(), lineno=1, col_offset=0)],
                value=ast.Call(
                    func=ast.Name(id='Matcher', ctx=ast.Load(), lineno=1, col_offset=10),
                    args=[ast.Call(
                        func=ast.Attribute(
                            value=ast.Call(
                                func=ast.Name(id='get_lang_class', ctx=ast.Load()),
            ...
            ast.With(
                items=[
                    ast.withitem(
                        context_expr=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='pytest', ctx=ast.Load(), lineno=2, col_offset=5),
                                attr='raises',
                                ctx=ast.Load(),
                                lineno=2, col_offset=11
                            ),
                            args=[ast.Name(id='ValueError', ctx=ast.Load(), lineno=2, col_offset=18)],
                            keywords=[],
                ...
                body=[
                    ast.Expr(
                        value=ast.Call(
                            func=ast.Attribute(
                                value=ast.Name(id='matcher', ctx=ast.Load(), lineno=3, col_offset=4),
                                attr='add',
                                ctx=ast.Load(),
                                lineno=3, col_offset=12
                            ),
                            args=[
                                ast.Constant(value=random_name, lineno=3, col_offset=16),
                                ast.List(elts=[], ctx=ast.Load(), lineno=3, col_offset=23),
                                ast.List(
                                    elts=[
                                        ast.Dict(
                                            keys=[ast.Constant(value=pattern, lineno=3, col_offset=29)],
                                            values=[ast.Constant(value='test', lineno=3, col_offset=36)],
                                            lineno=3, col_offset=29
                                        )
                                    ],
                                    ctx=ast.Load(),
                                    lineno=3, col_offset=28
                                )
                            ],
                            keywords=[],
                            lineno=3, col_offset=12
    ...
    def generate_failing_test(self) -> Tuple[ast.FunctionDef, TestResult]:
        _, fail_ = self._generate_one()
        random_name, pattern = fail_
        test = self.get_empty_test()
        test.body = self._get_assert(random_name, pattern)
        return test, TestResult.FAILING

    def generate_passing_test(self) -> Tuple[ast.FunctionDef, TestResult]:
        pass_, _ = self._generate_one()
        random_name, pattern = pass_
        test = self.get_empty_test()
        test.body = self._get_assert(random_name, pattern)
        return test, TestResult.PASSING
