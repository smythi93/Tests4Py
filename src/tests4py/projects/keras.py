...
def register():
    ...
    Keras(
        ...
        test_files=[Path("tests", "integration_tests", "test_image_data_tasks.py")],
        test_cases=[
            "tests",
            "integration_tests",
    ...
    Keras(
        ...
        test_files=[Path("tests", "keras", "applications", "imagenet_utils_test.py")],
        test_cases=[
            os.path.join(
                "tests",
                "keras",
    ...
    Keras(
        ...
        test_files=[Path("tests", "keras", "utils", "np_utils_test.py")],
        test_cases=[
            os.path.join(
