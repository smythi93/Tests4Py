...
class TestsPassing(unittest.TestCase):
    ...
    def test_diversity_1(self):
        self.assertEqual(True, match(Command('got commit -m IEogeEW [branch_name]', '', 'got: not found, maybe you meant "git"')))
    ...
    def test_diversity_4(self):
        self.assertEqual(True, match(Command('got commit -m oVUZgKT [branch_name]', '', 'got: not found, maybe you meant "git"')))
    ...
    def test_diversity_7(self):
        self.assertEqual(True, match(Command('got commit -m jBgySrnKjrlVUN [branch_name]', '', 'got: not found, maybe you meant "git"')))
